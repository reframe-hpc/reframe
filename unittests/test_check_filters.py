...
class TestCheckFilters(unittest.TestCase):
    ...
    def test_have_name(self):
        ...
        self.assertEqual(1, sn.count(filter(filters.have_name('check2'), 
                                            self.checks)))
        self.assertEqual(0, sn.count(filter(filters.have_name('check3'), 
                                            self.checks)))
        self.assertEqual(0, sn.count(filter(filters.have_name('check4'), 
                                            self.checks)))

    def test_have_not_name(self):
        self.assertEqual(1, sn.count(filter(filters.have_not_name('check1'), 
                                            self.checks)))
        self.assertEqual(1, sn.count(filter(filters.have_not_name('check2'), 
                                            self.checks)))
        self.assertEqual(2, sn.count(filter(filters.have_not_name('check3'), 
                                            self.checks)))
        self.assertEqual(2, sn.count(filter(filters.have_not_name('check4'),
                                            self.checks)))
    ...
    def test_have_tags(self):
        ...
        self.assertEqual(0, sn.count(filter(
            filters.have_tag(['a', 'b', 'c', 'd', 'e']), self.checks)))
        self.assertEqual(1, sn.count(filter(filters.have_tag(['x', 'y', 'z']), 
                                            self.checks)))
        self.assertEqual(0, sn.count(filter(filters.have_tag(['d', 'y']),
                                            self.checks)))

    def test_have_prgenv(self):
        self.assertEqual(1, sn.count(filter(filters.have_prgenv(['env1', 'env2']), 
                                            self.checks)))
        self.assertEqual(1, sn.count(filter(filters.have_prgenv(['env3']), 
                                            self.checks)))
        self.assertEqual(0, sn.count(filter(filters.have_prgenv(['env4']), 
                                            self.checks)))
        self.assertEqual(0, sn.count(filter(filters.have_prgenv(['env1', 'env3']), 
                                            self.checks)))

    @rt.switch_runtime(fixtures.TEST_SITE_CONFIG, 'testsys')
    def test_partition(self):
        p = rt.runtime().system.partition('gpu')
        self.assertEqual(1, sn.count(filter(filters.have_partition([p]), 
                                            self.checks)))
    ...
    def test_have_gpu_only(self):
        self.assertEqual(1, sn.count(filter(filters.have_gpu_only(), 
                                            self.checks)))
