...
class FixtureRegistry:
    ...
    identifies each of the registered fixture variants to be instantiated
    from the fixture class.

    This registry is responsible for assigning each of the fixture variants
    the appropriate name. Two different fixture variants from the same class
    must not have the same name. In this context, a fixture variant is
    determined by the fixture scope and a 4-element tuple containing the class
    variant number, a list with the valid environments, another list with the
    valid partitions and a key-value pair mapping with any fixture variables
    that may be set during the instantiation of the fixture.
    ...
    Since the fixture name is used as the fixture's unique ID, a fixture that
    modifies its :attr:`name` results in undefined behaviour.
    ...
    def add(self, fixture, variant_num, branch, partitions, prog_envs):
        ...
        This method sets the fixture name, ensuring that different fixture
        ...
        down into the fixture varies as a function of the fixture's scope.
        The rationale is as follows for the different scopes:
         ...
         - partition: Only one environment per partition. This kind of fixture
               ...
               partition. The name contains the partition to indicate the
               fixture scope.
         - environment: One fixture per available environment+partition
               ...
               combination. The name contains the partition and the environment
               to indicate the fixture scope.
         - test: Use the environments and partitions from the parent test
               ...
               any other test in the session. The name contains the ``branch``
               identifier to indicate the fixture scope.

        If a fixture modifies the default value of any of its attributes,
        these modified variables are always appended to the fixture name
        ...
        :param branch: The branch the fixture belongs to. This can be any form
            of branch ID, such as the root test name with its variant number,
            or the full concatenation of all the tests forming a particular
            branch.
        ...
        # Add the fixture variables to the name
        fname += ''.join(
...
class TestFixture:
    ...
    action, the parent test will reduce all the fixture variants from the
    same root test instance.
