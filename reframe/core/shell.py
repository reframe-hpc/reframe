...
class ShellScriptBuilder:
    ...
    def verbatim(self, stmt, suppress=False):
        """
        Append statement stmt verbatim. If suppress=True, stmt will not be in the
        generated script file but it will be returned from this function. This
        feature is useful when you want only the command that would be generated
        but you don't want it to be actually generated in the scipt file.
        """
        if not suppress:
