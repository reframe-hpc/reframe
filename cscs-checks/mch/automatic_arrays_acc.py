...
class AutomaticArraysCheck(rfm.RegressionTest):
    def __init__(self):
        ...
        self.arrays_reference = {
            'PrgEnv-cray': {
                'daint:gpu': {'time': (5.7E-05, None, 0.15, None)},
                'dom:gpu': {'time': (5.7E-05, None, 0.15, None)},
                'kesch:cn': {'time': (2.9E-04, None, 0.15, None)},
            },
            'PrgEnv-pgi': {
                'daint:gpu': {'time': (7.5E-05, None, 0.15, None)},
                'dom:gpu': {'time': (7.5e-05, None, 0.15, None)},
                'kesch:cn': {'time': (1.4E-04, None, 0.15, None)},
            }
        }
