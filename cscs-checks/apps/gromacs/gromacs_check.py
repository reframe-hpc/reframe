    ...
    allref = {
        1: {
            ...
            'broadwell': {
                ...
                'HECBioSim/Glutamine-Binding-Protein': (38.0, None, None, 'ns/day'),
        ...
        2: {
            ...
            'broadwell': {
                ...
                'HECBioSim/Glutamine-Binding-Protein': (65.0, None, None, 'ns/day'),
        ...
        6: {
            'sm_60': {
                ...
                'HECBioSim/Glutamine-Binding-Protein': (142.0, None, None, 'ns/day'),
            ...
            'broadwell': {
                ...
                'HECBioSim/Glutamine-Binding-Protein': (127.0, None, None, 'ns/day'),
                'HECBioSim/hEGFRDimer': (22.0, None, None, 'ns/day'),
        ...
        8: {
            'sm_60': {
                ...
                'HECBioSim/Glutamine-Binding-Protein': (149.0, None, None, 'ns/day'),
            ...
            'broadwell': {
                ...
                'HECBioSim/Glutamine-Binding-Protein': (158.0, None, None, 'ns/day'),
                'HECBioSim/hEGFRDimer': (28.0, None, None, 'ns/day'),
                'HECBioSim/hEGFRDimerSmallerPL': (39.0, None, None, 'ns/day'),
        ...
        16: {
            'sm_60': {
                'HECBioSim/Glutamine-Binding-Protein': (154.0, None, None, 'ns/day'),
            ...
            'broadwell': {
                'HECBioSim/Glutamine-Binding-Protein': (200.0, None, None, 'ns/day'),
