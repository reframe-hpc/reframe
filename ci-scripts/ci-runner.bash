...
if [ $CI_GENERIC -eq 1 ]; then
    ...
    tutorialchecks=( $(git diff origin/v2.17-backports...HEAD --name-only --oneline --no-merges | \
    ...
    userchecks=( $(git diff origin/v2.17-backports...HEAD --name-only --oneline --no-merges | \
