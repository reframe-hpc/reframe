...
The attribute :attr:`~reframe.core.pipeline.RegressionTest.keep_files` can be use to copy the files generated by EasyBuild to the output directory once the test has successfully finished:
