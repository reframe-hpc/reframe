...
If a test needs to be run on a situation where the reference values are unknown, the `self.reference` dictionary may be written as follows:
...
Doing this, the performance checks pass and the performance report will be printed as expected.
