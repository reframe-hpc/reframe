...
Let's consider a simple ReFrame test that installs ``zlib-1.3.1`` given the easyconfig `zlib-1.3.1.eb <https://github.com/easybuilders/easybuild-easyconfigs/blob/develop/easybuild/easyconfigs/z/zlib/zlib-1.3.1.eb>`__ and checks that the installed version is correct.
